...
$data = read_kategori("SELECT * FROM articles INNER JOIN categories ON articles.id_kategori = categories.id_kategori LIMIT $mulai, $halaman");
            ...
            <div class="col-md-12">
                <div class="card mb-5">
                    <div class="card-header bg-white">
                        <a href="artikel-tambah.php" class="btn btn-primary">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($data as $row) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $row['kategori'] ?></td>
                                            <td>
                                                <a href="artikel-hapus.php?id=<?= $row['id_artikel'] ?>" class="btn btn-sm btn-danger">
                                                    <span data-feather="trash" class="align-text-bottom"></span>
                                                </a>

                                                <a href="artikel-edit.php?id=<?= $row['id_artikel'] ?>" class="btn btn-sm btn-warning">
