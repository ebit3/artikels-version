...
$data = read_kategori("SELECT * FROM categories LIMIT $mulai, $halaman");
            ...
            <div class="col-md-12">
                <div class="card mb-5">
                    <div class="card-header bg-white">
                        <a href="kategori-tambah.php" class="btn btn-primary">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($data as $row) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $row['kategori'] ?></td>
                                            <td>
                                                <a href="kategori-hapus.php?id=<?= $row['id_kategori'] ?>" class="btn btn-sm btn-danger">
                                                    <span data-feather="trash" class="align-text-bottom"></span>
                                                </a>

                                                <a href="kategori-edit.php?id=<?= $row['id_kategori'] ?>" class="btn btn-sm btn-warning">
